...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row" id="notelist">
            <?php echo $__env->make('Student.noteslist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
$('#add_notes_form').on('submit', function(e) {
    ...
    $.ajax({
        url: '<?php echo e(URL::to("/student/addnotes")); ?>',
        method: 'POST',
        data: fd,
        processData: false,
        contentType: false,
...
function notelist() {
    ...
    $.ajax({
        url: '<?php echo e(URL::to("/student/notelist")); ?>',
        method: 'get',
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
...
$(document).on('click', '.delete', function() {
    var id = $(this).data('id');
    var ajaxurl = '<?php echo e(URL::to("student/deletenotes")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\education\resources\views/Student/notes.blade.php ENDPATH**/ ?>