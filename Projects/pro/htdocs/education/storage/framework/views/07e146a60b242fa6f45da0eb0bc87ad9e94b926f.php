...
<div class="page-content">
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="card">
                    ...
                    <ul class="nav nav-tabs nav-tabs-custom justify-content-center pt-2" role="tablist">
                        <h2> welcome to <?php echo e($data->coursename); ?></h2>
                    </ul>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xl-8">
                                        <div>
                                            <hr class="mb-4">
                                            <div>
                                                <h5><a href="blog-details.html" class="text-dark"><?php echo e($data->coursename); ?></a></h5>
                                                <p class="text-muted"><?php echo e($data->created_at); ?></p>
                        ...
                        <div>
                            ...
                            <ul class="list-unstyled fw-medium">
                                ...
                                <li><a href="javascript: void(0);" class="text-muted py-2 d-block"><i
                                            class="mdi mdi-chevron-right me-1"></i><?php echo e($val->name); ?></a></li>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\education\resources\views/Admin/viewcourse.blade.php ENDPATH**/ ?>