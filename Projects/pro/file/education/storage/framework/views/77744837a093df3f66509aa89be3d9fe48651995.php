...
<div class="col-md-6 col-xl-3">
    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <a href="<?php echo e(URL::to('/student/viewcourse',$val->id)); ?>" class="badge bg-success font-size-12 m-2">View Course</a>
        </div><!-- end col -->
    </div>
    <!-- end row -->
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp\htdocs\education\resources\views/Student/courselist.blade.php ENDPATH**/ ?>