...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row" id="courselist">
            <?php echo $__env->make('Admin.courselist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <div class="row">
            <div class="col-4">
                <div class="page-title-box d-flex align-items-center">
        ...
        <div class="row" id="courselist">
            <?php echo $__env->make('Admin.questionslist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!-- add course model -->
                    ...
                    <form method="post" id="addcourse_form">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo e(Auth::user()->id); ?>" class="form-control" name="tutorId"
                                    id="tutorId" hidden>
                            </div>
    ...
    function getcourselist() {
        ...
        $.ajax({
            url: '<?php echo e(URL::to("/admin/courselist")); ?>',
            method: 'get',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
    ...
    $('#reply_course_form').on('submit', function(e) {
        ...
        var fd = new FormData(this);
        $.ajax({
            url: '<?php echo e(URL::to("/admin/replycourse")); ?>',
            method: 'POST',
            data: fd,
            processData: false,
            contentType: false,
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\education\resources\views/Admin/dashboard.blade.php ENDPATH**/ ?>